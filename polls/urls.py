...
from polls.views import CategoryViewSet, CommentViewSet, PollViewSet, SimpleVoteViewSet, RankedVoteViewSet
...
router_v1.register(r'polls/(?P<poll_pk>\d+)/ranked_votes', RankedVoteViewSet, 'ranked_vote')
